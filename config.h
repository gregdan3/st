 ...
 * Using TTF means <C-Sh-[PgUp|PgDn]> will increase/reduce font size */
...
static char *font2[] = {
    ...
    "Font Awesome 5 Free Regular:pixelsize=20:antialias=true:autohint=true",
